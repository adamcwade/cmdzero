export default function Hero() {
  return (
    <section className="mx-auto max-w-4xl px-6 pt-24 pb-16 text-center">
      ...
      <h1 className="mt-4 text-5xl font-bold tracking-normal text-white">
        Know your users in minutes
      </h1>
      <p className="mt-6 text-lg text-slate-400">Acme turns raw product events into clear answers, so your team ships the right thing every week.</p>
